...
#'
#'
#' The core functions either fit a Beta-MPT model (\code{\link{betaMPT}};
#' Smith & Batchelder, 2010) or a latent-trait MPT model (\code{\link{traitMPT}};
...
#'
#' Schmidt, O., Erdfelder, E., & Heck, D. W. (2022).
